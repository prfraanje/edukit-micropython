...
spi = SoftSPI(polarity=1,phase=0,baudrate=L6474_instructions['SPI_FREQ'],sck=IHM01A1_pins['SPI_SCK_pin'],mosi=IHM01A1_pins['SPI_MOSI_pin'],
              miso=IHM01A1_pins['SPI_MISO_pin'],firstbit=SoftSPI.MSB)
